...
const data = [
  ...
  {
    "name": "schema",
    "variant_stage": "/config_staging/v1/seo/${locale}/schema.json",
  ...
  },
  {
    ...
    "variant_stage": "/resources/20191010_staging/${locale}/notification_tab.json",
  ...
  },
  {
    ...
    "variant_stage": "/resources/20191010_staging_prodtest/${locale}-${country}/categories_${men,women,kids,all,home}.json",
    "variant_prod": "/resources/20190121/${locale}-${country}/categories_${men,women,kids,all,home}.json"
  },
  {
    "name": "category_data",
    "variant_stage": "/resources/20191010_staging/${country-code}/categoryData.json",
    "variant_prod": "/resources/20190121/${country-code}/categoryData.json"
  },
  {
    "name": "categories_mega_menu",
    "variant_stage": "/resources/20191010_staging/${locale}/categories_mega_menu_${men,women,kids}.json",
    "variant_prod": "/resources/20190121/${locale}/categories_mega_menu_${men,women,kids}.json"
  },
  {
    "name": "store_page",
    "variant_stage": "/resources/20191010_staging/${locale}/${device-type}/store_page.json ",
    "variant_prod": "/resources/20190121/${locale}/${device-type}/store_page.json"
  }
];
...
const downloadAllUrls = async () => {
  ...
  console.log(`Starting download of ${total} URLs with concurrency ${CONCURRENCY}...`);
